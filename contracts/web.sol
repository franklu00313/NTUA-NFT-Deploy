...
contract ChiehContract is ERC721Enumerable, Ownable {
    ...
    // Constants
    uint256 public constant MAX_SUPPLY = 15; //可以被挖出來的NFT總數
    uint256 public mintPrice = 0.15 ether; //鑄造NFT的基本價錢
    uint256 public maxBalance = 5; //每個錢包地址可以擁有的NFT數量
    uint256 public maxMint = 3; //一次能挖的NFT支數
